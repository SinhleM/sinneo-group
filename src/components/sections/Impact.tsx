        ...
        <div className="flex-1">
          ...
          <ul className="mt-8 space-y-5 text-gray-800 max-w-md">
            <li className="flex items-start gap-3">
              <Leaf className="h-6 w-6 text-indigo-600 flex-shrink-0" />
              <span>Modular product design for lower maintenance and better reliability.</span>
            </li>
            <li className="flex items-start gap-3">
              <Cpu className="h-6 w-6 text-indigo-600 flex-shrink-0" />
              <span>AI that augments human work to boost productivity, not replace it.</span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="h-6 w-6 text-indigo-600 flex-shrink-0" />
              <span>Local-first solutions built for Johannesburg and Cape Town, with global ambitions.</span>
            </li>
          </ul>
        </div>
